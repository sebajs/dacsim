...
class Message760_Feature_Component
{
    const LENGTH = 60;
    ...
    private $iSubtype;
    private $sBitMask;
    private $iCreditAllowed;
    private $iPurchAllowed;
    private $iMaxPackCost;
    private $iTimeZoneID;
    private $iEpgRegion;
    private $iRegionConfig;
    private $iTurnOffVC;
    private $iTurnOnVC;
    private $iOutputChannel;
    private $iFeatSetting;
    private $sFeatSetting;
